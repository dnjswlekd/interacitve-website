(() => {
  ...
  const sceneInfo = [
    ...
    },
    {
      // 1
      type: 'normal',
      // heightNum: 5, //type normal에서는 필요없음 -> scrollHeight를 결정할때 innerHeight를 몇배롤 할지 결정할때 쓰이는데 normal은 컨텐츠 크기만큼이라 필요없음.
      scrollHeight: 0,
      objs: {
      ...
      case 3:
        ...
        if (scrollRatio < values.rect1X[2].end) {
          ...
          if (scrollRatio > values.blendHeight[2].end) {
            ...
            values.canvas_scale[2].end = values.canvas_scale[2].start;
            +0.2;
